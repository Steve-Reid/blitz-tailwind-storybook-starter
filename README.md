...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/proj-tlc-blitz-tailwind-ui
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/proj-tlc-blitz-tailwind-ui_test
```
